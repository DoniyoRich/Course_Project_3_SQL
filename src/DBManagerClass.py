...
class DBManager:
    ...
    def __init__(self, conn: Any, cur: Any) -> None:
        ...
        self.columns: list[str] = []  # будем сохранять названия столбцов, если потребуется сделать выборку в excel файл
        ...
        Так как элементов в кортеже может быть всегда разное количество в зависимости от запроса,
        то индексы необходимо обнулять после каждого запроса и перед выводом в консоль.
        """
        self.data = {
            'company': 0,
            'vacancy': 0,
